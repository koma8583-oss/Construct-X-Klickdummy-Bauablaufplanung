...
**How to apply:** For historical Project Agreement template versions without `baselinePurpose`, retain the documented `LEISTUNGSKOORDINATION` compatibility fallback. New template versions and fixtures should always provide an explicit baseline purpose and test a second allowed purpose as consent-required.