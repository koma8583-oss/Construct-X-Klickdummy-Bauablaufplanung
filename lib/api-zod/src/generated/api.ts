...
export const receiveInboundNotificationBodyHeaderContextRegExp = new RegExp('^urn:construct-x:(?:construction-service-coordination|data-publication|project-membership):notification:[a-z-]+:v[0-9]+$');
...
export const ListInboxMessagesResponseItem = zod.object({
  ...
  "payload": zod.record(zod.string(), zod.unknown()).describe('Typed payload. For TAKT_REQUEST_NOTIFICATION: contains taktRequestId, projectReference, leistungReference, requestVersion, responseRequiredBy, detailsRef, subject, message. No full Takt data.\n'),
