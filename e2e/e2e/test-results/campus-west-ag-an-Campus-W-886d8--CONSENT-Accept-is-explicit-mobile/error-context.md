...
- Name: campus-west-ag-an.spec.ts >> Campus-West · AG/AN policy coordination >> REQUIRES_CONSENT Accept is explicit
...
Locator: getByTestId('policy-consent-accepted')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByTestId('policy-consent-accepted')
...
- complementary:
  ...
  - navigation:
    ...
    - link "Hilfe":
      - /url: /an/hilfe
  - link "S Stahlbau Ruhr GmbH e2e-campus-west-bcfc97c7-cfdb-4b71-9028-f84c7cc572c2-an1@example.test":
    - /url: /an/settings
  - button "Abmelden"
- button
...
- main:
  - main:
    ...
    - paragraph: LEISTUNGSANFRAGE / e2e-campus-west-bcfc97c7-cfdb-4b71-9028-f84c7cc572c2:request-REQUIRES_CONSENT
    - text: In Prüfung
