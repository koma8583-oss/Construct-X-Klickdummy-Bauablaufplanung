...
- Name: campus-west-ag-an.spec.ts >> Campus-West · AG/AN policy coordination >> REQUIRES_CONSENT Reject is explicit
- Location: e2e/tests/campus-west-ag-an.spec.ts:17:9
...
Locator: getByTestId('policy-consent-rejected')
Expected: visible
Timeout: 10000ms
...
Call log:
  ...
  - waiting for getByTestId('policy-consent-rejected')

```

```yaml
- complementary:
  - link "Construct-X Lean Construction Scheduling Subcontractor":
    - /url: /an/
  - button
  - text: Stahlbau Ruhr GmbH
  - navigation:
    - link "Dashboard":
      - /url: /an/
    - link "Leistungen":
      - /url: /an/leistungen
    - link "Anfragen":
      - /url: /an/leistungsanfragen
    - link "Ressourcen":
      - /url: /an/resources
    - link "Nachrichten":
      - /url: /an/messages
    - paragraph: Weitere Bereiche
    - link "Datenraum":
      - /url: /an/data-room
    - link "Einstellungen":
      - /url: /an/settings
    - link "Hilfe":
      - /url: /an/hilfe
  - link "S Stahlbau Ruhr GmbH e2e-campus-west-b50f75cc-4dd9-455b-8144-b59a721095a8-an1@example.test":
    - /url: /an/settings
  - button "Abmelden"
- button
- text: Construct-X Subcontractor
- main:
  - main:
    - button "Zurück zu Anfragen"
    - paragraph: LEISTUNGSANFRAGE / e2e-campus-west-b50f75cc-4dd9-455b-8144-b59a721095a8:request-REQUIRES_CONSENT
    - text: In Prüfung
    - heading "Anfrage prüfen" [level=1]
    - paragraph: Nur der nächste erforderliche Schritt ist geöffnet. Abgeschlossene Angaben bleiben als Kontext verfügbar.
    - paragraph: Aktuelle Phase
    - paragraph: 1 · Anfrage prüfen
    - heading "Neue Nutzungsbedingungen" [level=2]
    - paragraph: Vor der Bestätigung sehen Sie nur die Metadaten und die konkrete Abweichung zur Projektvereinbarung.
    - list:
      - listitem: Terminfenster wurde konkretisiert
    - paragraph: "Geänderte Bereiche: Zeitraum"
    - button "Bestätigen und Details öffnen"
    - button "Ablehnen"
