...
- complementary:
  ...
  - navigation:
    ...
    - link "Hilfe":
      - /url: /an/hilfe
  - link "S Stahlbau Ruhr GmbH e2e-campus-west-abd87a8e-79cc-4e5d-9002-4fc22c37b969-an1@example.test":
    - /url: /an/settings
  - button "Abmelden"
- main:
  - main:
    - button "Zurück zu Anfragen"
    - paragraph: LEISTUNGSANFRAGE / e2e-campus-west-abd87a8e-79cc-4e5d-9002-4fc22c37b969:request-REQUIRES_CONSENT
    - text: In Prüfung
