...
- complementary:
  ...
  - navigation:
    ...
    - link "Hilfe":
      - /url: /an/hilfe
  - link "S Stahlbau Ruhr GmbH e2e-campus-west-d228cbc0-47c0-4524-9512-b2e97cc57dc0-an1@example.test":
    - /url: /an/settings
  - button "Abmelden"
- main:
  - main:
    - button "Zurück zu Anfragen"
    - paragraph: LEISTUNGSANFRAGE / e2e-campus-west-d228cbc0-47c0-4524-9512-b2e97cc57dc0:request-REQUIRES_CONSENT
    - text: In Prüfung
