...
- complementary:
  ...
  - navigation:
    ...
    - link "Hilfe":
      - /url: /an/hilfe
  - link "S Stahlbau Ruhr GmbH e2e-campus-west-bac8e349-b220-46da-a2d0-c0cbb20aa27c-an1@example.test":
    - /url: /an/settings
  - button "Abmelden"
- main:
  - main:
    - button "Zurück zu Anfragen"
    - paragraph: LEISTUNGSANFRAGE / e2e-campus-west-bac8e349-b220-46da-a2d0-c0cbb20aa27c:request-REQUIRES_CONSENT
    - text: In Prüfung
