...
- complementary:
  ...
  - navigation:
    ...
    - link "Hilfe":
      - /url: /an/hilfe
  - link "S Stahlbau Ruhr GmbH e2e-campus-west-ffd308c7-fe0c-4cef-8f94-4a949cbabd7e-an1@example.test":
    - /url: /an/settings
  - button "Abmelden"
- button
...
- main:
  - main:
    ...
    - paragraph: LEISTUNGSANFRAGE / e2e-campus-west-ffd308c7-fe0c-4cef-8f94-4a949cbabd7e:request-REQUIRES_CONSENT
    - text: In Prüfung
